 ...
 * @author Matheus
 */
public class FArmazem extends javax.swing.JInternalFrame {

    /**
     * Creates new form CadTipoServico
     */
    private CadArmazem controle;
    private ArmazemDao dao;
    private Armazem object;
    private ArrayList<Armazem> objects;
    ...
    private void init() {
        ...
        this.dao = new ArmazemDao();
        this.object = new Armazem();
        this.objects = new ArrayList();
        this.controle = new CadArmazem(this, dao, object, objects);
        this.estado = 1;

        this.Id_armazem.setText(UtilDao.selectProxId(object.getTABLE(), object.getPRIMARYKEY()) + "");
    ...
    private void initComponents() {
        ...
        Id_armazem = new javax.swing.JTextField();
        ...
        Id_armazem.setEditable(false);
        Id_armazem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Id_armazemActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(Id_armazem, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Id_armazem, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jbOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbOkActionPerformed
        ...
        if (controle.validView()) {
            ...
            if (estado == 1) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Armazém adicionado com sucesso!");
                ...
                JOptionPane.showMessageDialog(rootPane, "Armazém alterado com sucesso!");
    ...
    private void jbProcurarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbProcurarActionPerformed
        ...
        if (cc.getObject() instanceof Armazem && cc.getObject() != null) {
            this.object = (Armazem) cc.getObject();

            updateControl();
            this.controle.setView();
            this.estado = 2;
        } else {
            System.err.println("Erro ao retornar o Armazém");
            this.object = new Armazem();
            init();
    ...
    private void Id_armazemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Id_armazemActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Id_armazemActionPerformed
    ...
    private void jbDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbDeletarActionPerformed
        ...
        if (estado == 2) {
            ...
            if (JOptionPane.showConfirmDialog(this, "Você deseja excluir este registro?") == 0) {
                ...
                dao.delete(object, new Where(object.getPRIMARYKEY() + " = " + object.getId_armazem()));
    ...
    private void jbProcurar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbProcurar1ActionPerformed
        ...
        int escolha = 0;
        escolha = JOptionPane.showConfirmDialog(this, "Você deseja imprimir uma listagem do cadastro de Armazém?");

        if (escolha == 0) {
            RepArmazem rGP = new RepArmazem();
            Armazem obj = new Armazem();
            ArmazemDao gpDao = new ArmazemDao();
    ...
    public JTextField getId_armazem() {
        return Id_armazem;
    }

    public void setId_armazem(JTextField Id_armazem) {
    ...
    private javax.swing.JTextField Id_armazem;

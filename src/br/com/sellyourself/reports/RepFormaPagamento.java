 ...
 */
public class RepFormaPagamento {
    ...
    public void build(DRDataSource dataSource) {
        ...
        TextColumnBuilder<Integer> prazo = col.column("Prazo", "Prazo", type.integerType())
                .setHorizontalTextAlignment(HorizontalTextAlignment.LEFT);
                        ...
                        .title(
                                cmp.horizontalList()
                                        .add(
                                                ...
                                                cmp.text(" Listagem Forma Pagamento").setStyle(titleStyle).setHorizontalTextAlignment(HorizontalTextAlignment.RIGHT))
                                        .newRow()

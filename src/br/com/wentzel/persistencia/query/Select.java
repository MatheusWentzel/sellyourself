...
public class Select implements GetQuery {
    ...
    public Select(String table, String[] columns, ClauseSQL clause1, ClauseSQL clause2, ClauseSQL clause3, ClauseSQL clause4, ClauseSQL clause5) {
        this.table = table;
        this.columns = columns;
        this.query = "SELECT " + Script.getSelect(columns) + " FROM " + table + " "
                + clause1.getClause() + " "
    ...
    public Select(String table, String[] columns, ClauseSQL clause1, ClauseSQL clause2, ClauseSQL clause3, ClauseSQL clause4, ClauseSQL clause5, ClauseSQL clause6) {
        this.table = table;
        this.columns = columns;
        this.query = "SELECT " + Script.getSelect(columns) + " FROM " + table + " "
                + clause1.getClause() + " "
    ...
    public Select(String table, String[] columns, ClauseSQL clause1, ClauseSQL clause2, ClauseSQL clause3, ClauseSQL clause4, ClauseSQL clause5, ClauseSQL clause6, ClauseSQL clause7) {
        this.table = table;
        this.columns = columns;
        this.query = "SELECT " + Script.getSelect(columns) + " FROM " + table + " "
                + clause1.getClause() + " "
    ...
    public Select(String table, String[] columns, ClauseSQL clause1, ClauseSQL clause2, ClauseSQL clause3, ClauseSQL clause4, ClauseSQL clause5, ClauseSQL clause6, ClauseSQL clause7, ClauseSQL clause8) {
        this.table = table;
        this.columns = columns;
        this.query = "SELECT " + Script.getSelect(columns) + " FROM " + table + " "
                + clause1.getClause() + " "
